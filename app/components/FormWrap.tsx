...
const FormWrap = ({ children }: { children: React.ReactNode }) => {
	return (
		<div className='min-h-fit h-full flex item-center lg:items-center gap-5 lg:justify-between justify-center '>
			<div className=' max-w-[100%] lg:max-w-[50%] 2xl:ml-auto glassphormism !bg-white w-[550px] my-20 lg:mt-20 ml-10 mr-10 flex flex-col gap-6 items-center  rounded-md p-4 md:p-8'>
				{children}
			</div>
